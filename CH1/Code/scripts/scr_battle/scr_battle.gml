...
function scr_battle_steps()
{
	...
	if introDone
	{
		if get_json_file(_file,"spare-method") == "object-greenify" if place_meeting(x,y,asset_get_index(get_json_file(_file,"spare-object"))) && global.opponent_hp >= global.opponent_maxhp && global.flags[10] = true green += real(get_json_file(_file,"spare-power"))
